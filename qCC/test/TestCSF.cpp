...
private slots:
    ...
    void testCloud2CloudDistFlatGround()
    {
        ...
        wl::PointCloud pc;
        wl::Point p0{}; p0.x = 0.0f; p0.y = 0.0f; p0.z = 0.0f;
        wl::Point p1{}; p1.x = 1.0f; p1.y = 0.0f; p1.z = 0.0f;
        wl::Point p2{}; p2.x = 0.0f; p2.y = 0.0f; p2.z = 1.0f;
        wl::Point p3{}; p3.x = 1.0f; p3.y = 0.0f; p3.z = 1.0f;
        pc.push_back(p0);
        pc.push_back(p1);
        pc.push_back(p2);
        pc.push_back(p3);
    ...
    void testCloud2CloudDistPointAboveCloth()
    {
        ...
        wl::PointCloud pc;
        wl::Point above{}; above.x = 0.5f; above.y = 10.0f; above.z = 0.5f;
        pc.push_back(above);
