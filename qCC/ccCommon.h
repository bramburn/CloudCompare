 ...
 * @file ccCommon.h
 *
 * @brief Common constants and default scalar field names
 *
 * This header defines standard string constants used throughout CloudCompare
 * for scalar field names, distance computation results, and other shared
 * identifiers.
 *
 * @note Scalar field names are used to identify specific data types attached
 *       to point clouds (e.g., distances, curvatures, densities).
 *
