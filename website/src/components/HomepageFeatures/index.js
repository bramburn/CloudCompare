...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        <code>CloudCompare.exe</code> on Windows. <code>CloudCompare.app</code> on
        macOS and <code>AppImage</code>/<code>.deb</code> on Linux are
        community-supported (not CI-validated since 2026-08-24). Same Qt 6 UI,
        same code path, same plugin folder. Build scripts for each platform
        live in this docs site.
      </>
    ),
  },
];
