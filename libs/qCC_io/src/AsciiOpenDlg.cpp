...
/**
 * @file AsciiOpenDlg.cpp
 *
 * @brief ASCII file open dialog implementation
 *
 * Dialog for configuring ASCII file import parameters:
 * column mapping, separator, skip rows, coordinate transforms.
 *
 * ## Column Mapping
 *
 * - **X/Y/Z columns**: select which columns contain coordinates
 * - **RGB columns**: optional color columns
 * - **SF columns**: optional scalar field columns
 * - **Separator**: comma, semicolon, space, tab
 * - **Skip lines**: number of header lines to skip
 *
 * @see AsciiOpenDlg.h, AsciiFilter
 */
