...
/**
 * @file AsciiSaveDlg.cpp
 *
 * @brief ASCII file save dialog implementation
 *
 * Dialog for configuring ASCII file export parameters:
 * precision, separator, column selection.
 *
 * ## Export Options
 *
 * - **Separator**: comma, semicolon, space, tab
 * - **Precision**: decimal places for coordinates
 * - **Columns**: include XYZ, RGB, SF values
 * - **Header**: optional column name row
 * - **Point count**: optional leading row with total points
 *
 * @see AsciiSaveDlg.h, AsciiFilter
 */
