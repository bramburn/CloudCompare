...
/**
 * @file ccShiftAndScaleCloudDlg.cpp
 *
 * @brief Shift and scale cloud dialog implementation
 *
 * Dialog for manually applying coordinate shifts and scales.
 *
 * ## Parameters
 *
 * - **Shift**: constant X/Y/Z translation
 * - **Scale**: per-axis or uniform scaling
 * - **Apply to coordinates**: directly modify point coordinates
 * - **Apply to global shift**: store as global shift (preserves precision)
 *
 * Used when registering clouds from different coordinate systems.
 *
 * @see ccShiftAndScaleCloudDlg.h
 */
