 ...
 * @file ccExtru.cpp
 *
 * @brief Extrusion primitive implementation
 *
 * Implements ccExtru: a 2D shape extruded along a 3D axis.
 *
 * ## Extrusion Geometry
 *
 * - **Profile**: a 2D polyline defining the cross-section shape
 * - **Height**: extrusion length along the axis direction
 * - **Axis**: direction vector for the extrusion
 *
 * The mesh is generated by extruding the profile along the axis,
 * connecting corresponding vertices with quads/triangles.
 *
 * ## Use Cases
 *
 * - Creating prismatic shapes (beams, pipes) from 2D profiles
 * - Modeling extruded terrain features
 *
 * @see ccExtru.h
 */
