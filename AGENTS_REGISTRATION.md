...
| **M8** | CI parity: add `-DPLUGIN_STANDARD_QMANUAL_REGISTRATION=ON` to `.github/workflows/build.yml` (1 job: Windows MSVC — macOS and Linux are not in the matrix). | CI green. |
