...
**Standard Plugins:** qAnimation (qAnimation, qAnimationDlg), qBroom (qBroom, qBroomDlg), qCanupo (qCanupoTools), qCloudLayers (ccCloudLayersDlg, ccCloudLayersHelper), qCompass (ccCompass), qCork (qCork), qCSF (qCSF), qFacets (qFacets), qHPR (qHPR), qHoughNormals (qHoughNormals), qM3C2 (qM3C2), qPCV (qPCV), qRANSAC_SD (qRansacSD), qSRA (qSRA)
