...
**Standard Plugins:** qAnimation (qAnimation, qAnimationDlg), qBroom (qBroom, qBroomDlg), qCanupo (qCanupoTools), qCloudLayers (ccCloudLayersDlg, ccCloudLayersHelper), qCSF (qCSF)
