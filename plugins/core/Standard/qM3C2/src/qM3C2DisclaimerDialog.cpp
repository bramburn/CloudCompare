...
/**
 * @file qM3C2DisclaimerDialog.cpp
 *
 * @brief M3C2 algorithm disclaimer dialog
 *
 * Shows the academic disclaimer and citation request
 * when the qM3C2 plugin is activated.
 *
 * Paper: Lague et al. 2013, "3D terrestrial lidar
 * time-series analysis of the earth surface processes."
 *
 * @see qM3C2DisclaimerDialog.h
 */
