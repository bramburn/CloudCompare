...
/**
 * @file qCanupo2DViewDialog.cpp
 *
 * @brief Canupo 2D classification view dialog
 *
 * Displays per-classification results in a 2D scatter plot:
 * - X-axis: class probability (output of classifier)
 * - Y-axis: scale index (which scale the point was classified at)
 * - Color: assigned class
 *
 * Useful for understanding classification confidence and
 * which scale dominates for each point.
 *
 * @see qCanupo2DViewDialog.h
 */
