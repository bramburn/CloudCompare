 ...
 *
 * Dialog for configuring multi-scale point cloud classification:
 * - **Scales**: list of analysis radii (e.g., 0.1, 0.3, 0.5, 1.0m)
 * - **Classes**: class names and colors
 * - **Model file**: path to the trained .dat classifier
 * - **Output**: SF name for classification results
 *
 * @see qCanupoClassifDialog.h
 */
