...
/**
 * @file qCanupoTrainingDialog.cpp
 *
 * @brief Canupo classifier training dialog
 *
 * Trains an AdaBoost classifier using manually labeled point clouds:
 * 1. **Training set**: select labeled point cloud regions per class
 * 2. **Feature extraction**: compute multi-scale geometric features
 * 3. **Training**: AdaBoost decision stumps (via dlib)
 * 4. **Validation**: cross-validation on training data
 * 5. **Export**: save as .dat file for use in qCanupoClassifDialog
 *
 * @see qCanupoTrainingDialog.h
 */
