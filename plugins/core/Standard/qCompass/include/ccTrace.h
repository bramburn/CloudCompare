...
/*
A ccCompassTrace object is essentially a ccPolyline that is controlled/created by "waypoints" and a least-cost path algorithm
...
If treated as a ccCompassTrace object, then the waypoints can be manipulated and the underlying ccPolyline recalculated. For convenience, 
...
public:
	...
	ccCompassTrace(ccPolyline* poly); //used for constructing from polylines with the correct metadata
