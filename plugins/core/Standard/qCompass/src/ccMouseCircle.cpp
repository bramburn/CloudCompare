 ...
 *
 * @brief Compass mouse circle tool
 *
 * Interactive circular selection tool:
 * - Click-drag to define a circle on the point cloud surface
 * - Used to select points within a circular region
 * - Useful for defining measurement circles on outcrops
 *
 * @see ccMouseCircle.h
 */
