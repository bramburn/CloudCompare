...
/**
 * @file ccLineation.cpp
 *
 * @brief Compass lineation implementation
 *
 * A linear geological feature:
 * - **Trend**: azimuth of the line direction (0-360)
 * - **Plunge**: angle from horizontal (0-90)
 * - **Pitch**: angle within the host plane (for lineations on planes)
 *
 * Lineations include fold axes, mineral lineations,
 * slickensides, and stretched clasts.
 *
 * @see ccLineation.h
 */
