...
/**
 * @file ccCompassDlg.cpp
 *
 * @brief Compass main dialog implementation
 *
 * Central dialog for the Compass plugin:
 * - **Toolbar**: digitising tools (trace, fit plane, lineation, etc.)
 * - **Object list**: tree view of all geo-objects
 * - **Properties**: selected object parameters
 * - **Stereo net**: lower-hemisphere equal-area projection
 *
 * @see ccCompassDlg.h
 */
