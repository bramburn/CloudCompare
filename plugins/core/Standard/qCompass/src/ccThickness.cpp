...
/**
 * @file ccThickness.cpp
 *
 * @brief Compass thickness measurement implementation
 *
 * Represents a geological layer thickness measurement:
 * - **Apparent thickness**: perpendicular distance in the section plane
 * - **True thickness**: minimum perpendicular distance between bounding planes
 * - **Normal thickness**: perpendicular to bedding planes
 *
 * Computed from two fitted planes (hanging wall and footwall)
 * with the angle between them.
 *
 * @see ccThickness.h
 */
