...
/**
 * @file ccCompassExport.cpp
 *
 * @brief Compass export implementation
 *
 * Exports Compass projects to various formats:
 * - **DXF**: geological map with planes as polylines, symbols
 * - **CSV**: measurement table (strike/dip, location)
 * - **Shapefile**: points and polylines for GIS
 * - **Compass XML**: full project with all objects and topology
 * - **Stereo net**: PNG/SVG of the current stereo plot
 *
 * @see ccCompassExport.h
 */
