...
/**
 * @file ccTopologyRelation.cpp
 *
 * @brief Compass topology relation implementation
 *
 * Represents a geological relationship between two geo-objects:
 * - **Cross-cuts**: A cuts/displaces B
 * - **Overprints**: A overprints B (A is younger)
 * - **Coplanar**: A and B are parallel/parallel-subparallel
 * - **Convergent/Divergent**: dip directions toward/away from each other
 *
 * The topology graph encodes the relative age relationships
 * used to build the geological history sequence.
 *
 * @see ccTopologyRelation.h
 */
