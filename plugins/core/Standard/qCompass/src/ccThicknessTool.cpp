...
/**
 * @file ccThicknessTool.cpp
 *
 * @brief Compass thickness measurement tool
 *
 * Interactive tool for measuring layer thickness:
 * 1. Pick two planes (hanging wall and footwall)
 * 2. Pick a measurement point
 * 3. Compute apparent and true thickness at that point
 *
 * Uses the angle between the two planes to correct
 * the apparent thickness to true thickness.
 *
 * @see ccThicknessTool.h
 */
