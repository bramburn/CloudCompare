/**
 * @file ccCompassImport.cpp
 *
 * @brief Compass import implementation
 *
 * Imports external data into Compass projects:
 * - **Compass XML**: full project restoration
 * - **DXF**: georeferenced polylines and points
 * - **CSV**: bulk measurement import
 * - **LAS/LAZ**: point clouds from TLS surveys
 *
 * @see ccCompassImport.h
 */
