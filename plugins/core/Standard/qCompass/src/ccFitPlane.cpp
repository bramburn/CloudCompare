 ...
 * @file ccFitPlane.cpp
 *
 * @brief Compass fitted plane implementation
 *
 * A geological plane feature fitted to selected points:
 * - Stores fitted normal vector and center point
 * - Computes strike and dip (geological convention)
 * - Calculates fitting residuals
 *
 * ## Strike/Dip Convention
 *
 * Strike: azimuth of the horizontal trace (right-hand rule)
 * Dip: maximum angle from horizontal (0-90 degrees)
 * Dip direction: strike + 90 degrees
 *
 * @see ccFitPlane.h
 */
