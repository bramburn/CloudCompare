...
/**
 * @file ccGeoObject.cpp
 *
 * @brief Compass geological object implementation
 *
 * Base class for all geological features in Compass:
 * - **ccFitPlane**: planar features (bedding, foliation, joints)
 * - **ccLineation**: linear features (fold axes, lineations)
 * - **ccPinchNode**: pinch-out nodes
 * - **ccTrace**: digitised trace polylines
 * - **ccThickness**: apparent/true thickness measurements
 *
 * ## Common Properties
 *
 * - Name and label
